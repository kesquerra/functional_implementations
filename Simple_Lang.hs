...
-- | 2 + 3 * x
expr1 :: Expr
expr1 = Add (I 2) (Mul (I 3) (V "x"))

-- | 2 + 3 * x + 4
expr2 :: Expr
expr2 = Add (Add (I 2) (Mul (I 3) (V "x"))) (I 4)

-- | (x + 2) * 3 * y
expr3 :: Expr
expr3 = Mul (Mul (Add (V "x") (I 2)) (I 3)) (V "y")

-- | (x + 2) * (y + 3)
expr4 :: Expr
expr4 = Mul (Add (V "x") (I 2)) (Add (V "y") (I 3))
...
boxBody = [Pen Up, 
          Move (V "x") (V "y"),
          Pen Down,
          Move (Add (V "x") (V "w")) (V "y"),
          Move (Add (V "x") (V "w")) (Add (V "y") (V "h")),
          Move (V "x") (Add (V "y") (V "h")),
          Move (V "x") (V "y")]
...
--   }
mainBody :: Block
mainBody = [For "i" (I 1) (I 15) [Call "box" [V "i", V "i", V "i", V "i"]]]
...
--   "pen down"
--
--   >>> prettyCmd (Move (I 2) (Add (V "x") (I 3)))
--   "move(2, (x + 3))"
--
--   >>> prettyCmd (Call "foo" [I 2, (Mul (V "x") (I 3))])
--   "foo(2, (x * 3))"
--
--   >>> prettyCmd (For "i" (I 1) (I 10) [])
--   "for i = 1 to 10 {}"
--
prettyCmd :: Cmd -> String
prettyCmd (Pen x) = "pen " ++ prettyMode x
prettyCmd (Move x y) = "move(" ++ prettyExpr x ++ ", " ++ prettyExpr y ++ ")"
prettyCmd (Call m x) = m ++ "(" ++ intercalate ", " (map prettyExpr x) ++ ")"
prettyCmd (For v a z x) = "for " ++ v ++ " = " ++ prettyExpr a ++ " to " ++ prettyExpr z ++ " " ++ prettyBlock x
...
--   "{}"
--
--   >>> putStrLn (prettyBlock [Pen Up, Move (I 2) (I 3), Pen Down])
--   {
--     pen up;
--     move(2, 3);
--     pen down
